...
// ============================ Core Functions ============================
// ========================================================================
TestVelocityController::~TestVelocityController()
{
  {
...
CallbackReturn TestVelocityController::on_init() 
{
  try 
  {
    ...
    if (!compute_thread_.joinable())
    {
      ...
      compute_thread_ = std::thread(&TestVelocityController::computeWorkerLoop, this);
    }
...
void TestVelocityController::computeWorkerLoop()
{
