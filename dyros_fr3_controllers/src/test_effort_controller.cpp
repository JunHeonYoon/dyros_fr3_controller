#include "dyros_fr3_controllers/test_effort_controller.h"
...
controller_interface::InterfaceConfiguration TestEffortController::command_interface_configuration() const 
{
...
controller_interface::InterfaceConfiguration TestEffortController::state_interface_configuration() const 
{
...
// ========================================================================
void TestEffortController::compute()
{
...
void TestEffortController::updateJointStates() 
{
  std::lock_guard<std::mutex> lk(robot_data_mutex_);
  for (int i = 0; i < num_joints; ++i) 
  {
...
// =========================== ROS Subs & Pubs  ===========================
// ========================================================================
void TestEffortController::controlModeCallback(const std_msgs::msg::Int32& msg)
{
...
// ========================== Utility Functions ===========================
// ========================================================================	
Eigen::Vector7d TestEffortController::JointPDControl(const Eigen::Vector7d target_q, const Eigen::Vector7d target_qdot)
{
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(dyros_fr3_controllers::TestEffortController,
