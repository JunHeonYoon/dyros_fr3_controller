#include "dyros_fr3_controllers/test_position_controller.h"
...
CallbackReturn TestPositionController::on_init() 
{
  try 
  {
    ...
    control_mode_sub_ = get_node()->create_subscription<std_msgs::msg::Int32>(
      "test_position_controller/control_mode",
      rclcpp::QoS(10),
      std::bind(&TestPositionController::controlModeCallback, this, std::placeholders::_1)
    );
    ...
    if (!compute_thread_.joinable())
    {
      ...
      compute_thread_ = std::thread(&TestPositionController::computeWorkerLoop, this);
    }
...
controller_interface::InterfaceConfiguration TestPositionController::command_interface_configuration() const 
{
...
controller_interface::InterfaceConfiguration TestPositionController::state_interface_configuration() const 
{
...
CallbackReturn TestPositionController::on_configure(const rclcpp_lifecycle::State& /*previous_state*/) 
{
...
CallbackReturn TestPositionController::on_activate(const rclcpp_lifecycle::State& /*previous_state*/) 
{
...
controller_interface::CallbackReturn TestPositionController::on_deactivate(const rclcpp_lifecycle::State& /*previous_state*/) 
{
  franka_robot_model_->release_interfaces();
  return CallbackReturn::SUCCESS;
}

controller_interface::return_type TestPositionController::update(const rclcpp::Time& /*time*/, const rclcpp::Duration& period)
{
...
// ========================================================================
void TestPositionController::compute()
{
...
void TestPositionController::updateJointStates() 
{
  std::lock_guard<std::mutex> lk(robot_data_mutex_);
  for (int i = 0; i < num_joints; ++i) 
  {
...
void TestPositionController::updateRobotData()
{
...
void TestPositionController::computeWorkerLoop()
{
...
void TestPositionController::setMode(CtrlMode mode)
{
...
// =========================== ROS Subs & Pubs  ===========================
// ========================================================================
void TestPositionController::controlModeCallback(const std_msgs::msg::Int32& msg)
{
...
// NOLINTNEXTLINE
PLUGINLIB_EXPORT_CLASS(dyros_fr3_controllers::TestPositionController,
